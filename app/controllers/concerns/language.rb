module Language
    ...
    def language!
        ...
        text = t('command.language_source.text', { options: options.join("\n")})
    ...
    def language_source(language_source= '',*)
        ...
        text = t('command.language_translation.text', { options: options.join("\n"), language_source: language_source_text }) 
    ...
    def language_translation(translation= '',*)
        ...
        respond_with :message, text: "We'll translate from *#{language_from}* to *#{language_to}*", parse_mode: 'Markdown'
    end
